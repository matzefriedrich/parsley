...
* Bumps `golang.org/x/mod` from 0.40.0 to 0.41.0- [#98](https://github.com/matzefriedrich/parsley/pull/98)
* Bumps `github.com/matzefriedrich/cobra-extensions` from 0.8.0 to 0.9.0- [#99](https://github.com/matzefriedrich/parsley/pull/99)
...
* Bumps `golang.org/x/mod` from 0.35.0 to 0.37.0 [#84](https://github.com/matzefriedrich/parsley/pull/84), [#85](https://github.com/matzefriedrich/parsley/pull/85)
...
[#72](https://github.com/matzefriedrich/parsley/pull/72)
* Upgrades Go version to 1.26.2


## [v1.3.2] - 2026-02-09

* Bumps `golang.org/x/mod` from 0.32.0 to 0.33.0 [#69](https://github.com/matzefriedrich/parsley/pull/69)
* Upgrades Go version to 1.25.7
...
* Bumps `golang.org/x/mod` from 0.29.0 to 0.32.0 [#66](https://github.com/matzefriedrich/parsley/pull/66), [#68](https://github.com/matzefriedrich/parsley/pull/68)
